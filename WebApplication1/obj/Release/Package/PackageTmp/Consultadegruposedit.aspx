<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Consultadegruposedit.aspx.cs" Inherits="WebApplication1.Consultadegruposedit" %>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    <asp:label ID="LObservaciones" runat="server"  ></asp:label>
                      ...
                      <div class="form-group">
                  <label for="labepresupuesto" class="col-sm-2 control-label" style="height:auto;">Presupuesto</label>
                  <div class="col-sm-4">
                    <asp:label ID="LPresupuesto" runat="server"  ></asp:label>
                  </div>
                </div>
                   </div>
               <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                   ...
                   <div class="form-group">
                  <label for="labeEstrategias" class="col-sm-2 control-label" style="height:auto;">Estrategias</label>
                  <div class="col-sm-4">
                    <asp:label ID="LEstrategias" runat="server"  ></asp:label>
                  </div>
                </div>
               </div>
